...
<head>
    ...
    <title>Admin - Editar historico</title>
...
<body>
    ...
    <div class="container mt-5 pt-5">
        <h2 class="text-center mb-4">Editar historico</h2>
        ...
        <form method="post" enctype="multipart/form-data" action="/historico/${id}/editar">
            <!-- Campos Básicos -->
            <div class="mb-3">
