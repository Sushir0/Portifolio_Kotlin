...
<head>
    ...
    <title>Admin - Nova Feature</title>
...
<body>
    ...
    <div class="container mt-5 pt-5">
        <h2 class="text-center mb-4">Criar feature</h2>
        ...
        <form method="post" enctype="multipart/form-data" action="/feature/create">
            <!-- Campos Básicos -->
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label class="form-label">Imagem da feature</label>
